...
public class MessageContentProvider extends ContentProvider {
    ...
    public static final String PROVIDER_NAME = "edu.stevens.provider.MessageContentProvider";
    ...
    private static final String DATABASE_NAME = "pppp";
    private static final String SQLITE_TABLE = "asd";
