...
public class PeerContentProvider extends ContentProvider {
    ...
    public static final String URL2 = "content://" + PROVIDER_NAME + "/User";
    ...
    private static final String SQLITE_TABLE2 = "lll";
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        switch (uriMatcher.match(uri)) {
            ...
            case Message_ID:
                ...
                String query3 = "select *  from "+ SQLITE_TABLE +" where "+SQLITE_TABLE+".name='"+name+"'";
                cursor =  database.rawQuery(query3, null);
                break;
            case User:
                String query2 = "select *  from "+ SQLITE_TABLE2 ;
    ...
    public Uri insert(Uri uri, ContentValues values) throws SQLException{
        ...
        switch (uriMatcher.match(uri)) {
            ...
            case Message_ID:
                break;
            case User:
                long s = database.insert(SQLITE_TABLE2, null, values);

                // If record is added successfully
                if (s > 0) {
                    Uri newUri = ContentUris.withAppendedId(CONTENT_URI, s);
                    getContext().getContentResolver().notifyChange(newUri, null);
                    return newUri;
                }
                break;
